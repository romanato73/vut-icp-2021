...
public:
    ...
    void setupUi(QDialog *CreateBlockDialog)
    {
        ...
        CreateBlockDialog->setMaximumSize(QSize(16777215, 16777215));
        CreateBlockDialog->setStyleSheet(QString::fromUtf8("QDialog {\n"
...
"	image: url(:images/drop-arrow.png);\n"
"	width: 14px;\n"
"	height: 14px;\n"
"	margin-right: 10px;\n"
"}\n"
...
"}"));
        ...
        label = new QLabel(CreateBlockDialog);
        ...
        blockName->setStyleSheet(QString::fromUtf8(""));
        ...
        blockCategory->setStyleSheet(QString::fromUtf8(""));
        ...
        inputs->setStyleSheet(QString::fromUtf8(""));
        ...
        outputs->setStyleSheet(QString::fromUtf8(""));
        ...
        createBlock->setStyleSheet(QString::fromUtf8(""));
    ...
    {
        CreateBlockDialog->setWindowTitle(QCoreApplication::translate("CreateBlockDialog", "Create a block", nullptr));
        label->setText(QCoreApplication::translate("CreateBlockDialog", "Create a block", nullptr));
