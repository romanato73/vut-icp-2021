...
public:
    ...
    void setupUi(QDialog *EditCategoryDialog)
    {
        ...
        EditCategoryDialog->resize(300, 165);
        EditCategoryDialog->setMaximumSize(QSize(300, 165));
        EditCategoryDialog->setWindowOpacity(1.000000000000000);
        EditCategoryDialog->setStyleSheet(QString::fromUtf8("QDialog {\n"
...
"}"));
    ...
    {
        EditCategoryDialog->setWindowTitle(QCoreApplication::translate("EditCategoryDialog", "Edit a category", nullptr));
        label_2->setText(QCoreApplication::translate("EditCategoryDialog", "Edit a category", nullptr));
